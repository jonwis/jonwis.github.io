...
{
    /*
        This adds a vtable wrapper around the cached runtimeclass object above, pushing the caching logic down one level.
        It's better than above, but worse than normal cppwinrt. Each call site for Insert() looks like:
