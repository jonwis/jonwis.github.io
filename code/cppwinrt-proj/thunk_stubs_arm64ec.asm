; thunk_stubs_arm64ec.asm - ARM64EC thunk stubs for generic interface caching
;
; ARM64EC uses ARM64 instructions with x64-compatible calling convention.
; The logic is identical to the ARM64 version. The ARM64EC runtime's
; Fast Forward Sequences handle x64<->ARM64EC transitions at call boundaries.
